...
def test_loadbalancer_cloudfront_forward_refused(loadbalancer_cloudfront_forward_refused):
    ...
    assert entry == LoadBalancerLogEntry(
        ...
        matched_rule_priority=0,
        request_creation_time=datetime.datetime(2018, 11, 30, 22, 22, 48,
            364000, tzinfo=datetime.timezone.utc),
        actions_executed=['waf', 'forward'],
        redirect_url=None,
        error_reason=None,
    )
...
def test_loadbalancer_http_entry(loadbalancer_http_entry):
    ...
    assert entry == LoadBalancerLogEntry(
        type=HttpType.Http,
        timestamp=datetime.datetime(2018, 7, 2, 22, 23, 0, 186641, tzinfo=datetime.timezone.utc),
        elb='app/my-loadbalancer/50dc6c495c0c9188',
        client=Host(
            ip='192.168.131.39',
            port=2817,
        ...
        chosen_cert_arn=None,
        matched_rule_priority=0,
        request_creation_time=datetime.datetime(2018, 7, 2, 22, 22, 48, 364000, tzinfo=datetime.timezone.utc),
...
def test_loadbalancer_lambda_entry(loadbalancer_lambda_entry):
    ...
    assert entry == LoadBalancerLogEntry(
        type=HttpType.Http,
        timestamp=datetime.datetime(2018, 11, 30, 22, 23, 0, 186641, tzinfo=datetime.timezone.utc),
        elb='app/my-loadbalancer/50dc6c495c0c9188',
        client=Host(
            ip='192.168.131.39',
            port=2817,
        ...
        chosen_cert_arn=None,
        matched_rule_priority=0,
        request_creation_time=datetime.datetime(2018, 11, 30, 22, 22, 48, 364000, tzinfo=datetime.timezone.utc),
        actions_executed=['forward'],
        redirect_url=None,
        error_reason=None,
    )
